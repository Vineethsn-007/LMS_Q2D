...
const ReviewerProtectedRoute = ({ user, children }) => {
  ...
  return (
    <div className="reviewer-login-container" style={{
      display: 'flex',
      alignItems: 'center',
      ...
      <div className="reviewer-login-card glass" style={{
        background: 'white',
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 800, color: '#0f172a', marginBottom: '0.5rem' }}>Reviewer Access Required</h2>
          <p style={{ fontSize: '0.9rem', color: '#64748b' }}>Please authenticate with reviewer credentials to access the Review Center.</p>
        </div>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
            <label style={{ fontSize: '0.85rem', fontWeight: 600, color: '#475569' }}>Reviewer Email</label>
            <input 
              type="email" 
              required
              placeholder="reviewer@skillforge.com"
              value={email}
